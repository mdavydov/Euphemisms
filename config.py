...
SYSTEM_PROMPT2 = "Напиши 1, якщо вираз в кутових дужках є евфемізмом, інакше  0. Також напиши, в якому значенні використано цей вираз"
SYSTEM_PROMPT = "Напиши 1, якщо вираз в кутових дужках є евфемізмом, інакше  0. "
